...
export const article = {
  author: 'Jay',
  date: '2025-04-01',
  title: 'AI Powered Design System - MCP Server',
  description: 'Design System MCP Server bridges the gap between AI prototyping and production by leveraging the Model Context Protocol (MCP). It provides a standardized way for AI models to access, utilize, and generate design system components and guidelines. ',
}
